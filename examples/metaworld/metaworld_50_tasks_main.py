...
def get_data_loader(dataset_path, opt, gamma=0.99):
    ...
    # dataset_path = os.path.abspath("data/metaworld_50_tasks_img.pkl")
...
def main():
    ...
    val_dataset_path = os.path.abspath("data/metaworld_50_tasks_img_val.pkl")
    val_loader = get_data_loader(val_dataset_path, opt)
    fig = visualize(opt, encoder, val_loader)
    # fig_path = "figures/metaworld_door_open_v2_img_repr_vis.html"
    fig_path = "figures/metaworld_50_tasks_val_img_repr_vis.html"
    fig.write_html(fig_path, include_mathjax='cdn')
    print("Figure save to: {}".format(fig_path))
